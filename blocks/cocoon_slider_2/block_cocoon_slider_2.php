                         ...
                         <div class="row">
                             ...
                             if (!empty($data->$slide_btn_url) && !empty($data->$slide_btn_text)) {
                               $text .='<div class="btn-block">
                                          <a target="'.$data->$slide_btn_target.'" href="'.format_text($data->$slide_btn_url, FORMAT_HTML, array('filter' => true)).'" class="banner-btn">'.format_text($data->$slide_btn_text, FORMAT_HTML, array('filter' => true)).'</a>
                                        </div>';
                             }
                             $text .='</div>
                         </div>
