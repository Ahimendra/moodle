...
class block_cocoon_course_categories_2 extends block_list {
    function init() {
    ...
    function get_content() {
        ...
        $adminseesall = true;
        if (isset($CFG->block_cocoon_course_categories_2_adminview)) {
           if ( $CFG->block_cocoon_course_categories_2_adminview == 'own'){
               $adminseesall = false;
           }
        }
