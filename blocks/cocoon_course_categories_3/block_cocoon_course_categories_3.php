...
class block_cocoon_course_categories_3 extends block_list {
    function init() {
    ...
    function get_content() {
        ...
        // $adminseesall = true;
        // if (isset($CFG->block_cocoon_course_categories_3_adminview)) {
        //    if ( $CFG->block_cocoon_course_categories_3_adminview == 'own'){
        //        $adminseesall = false;
        //    }
        // }
        ...
        <div class="col-lg-6">
              <div class="ccn-section-top-more pull-right mt0 mb20">
                <a class="" href="'.$CFG->wwwroot .'/course/index.php">'.$this->content->button_text.'</a>
              </div>
            ...
            for ($i = 0; $i <= $data->items; $i++) {
              ...
              if ($DB->record_exists('course_categories', array('id' => $data->$categoryID))) {
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-lg-5th-1">
					<a href="'.$CFG->wwwroot .'/course/index.php?categoryid='.$categoryID.'" class="icon_hvr_img_box ccn-color-cat-boxes" style="background:'.$data->$color.';">
						<div class="overlay">
							<div class="icon ccn_icon_2 color-white"><span class="'.$data->$icon.'"></span></div>
							<div class="details">
								<h5 class="color-white">'.$categoryname.'</h5>';
                                    if($this->content->body != '1'){
                                      $this->content->footer .='<p class="color-white">'. format_string($category->description, $striplinks = true,$options = null).'</p>';
                                    } else {
