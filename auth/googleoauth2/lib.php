...
/*echo $state;echo "<br>";
echo $_SESSION['oauth2state_' . $providername];die;*/
...
function auth_googleoauth2_render_buttons() {
    ...
    $allauthproviders = optional_param('allauthproviders', true, PARAM_BOOL);
    ...
    if ( count ($providers) > 0 ) {
        ...
        foreach ($providers as $providername) {
            ...
            $providerdisplaystyle = $displayprovider ? 'display:inline-block;padding:5px;' : 'display:none;';
